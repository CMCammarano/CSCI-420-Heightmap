...
class PipelineProgram {
	public:
		...
		void Bind();																				// binds (activates) all the provided shaders 
		GLuint GetProgramHandle() { return programHandle; }											// get program handle
...
/****************************************************************/
// Mysterious define for setting the shader value
/****************************************************************/
