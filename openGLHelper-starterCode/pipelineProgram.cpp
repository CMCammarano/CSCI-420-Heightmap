...
PipelineProgram::~PipelineProgram() { glDeleteProgram(programHandle); }

int PipelineProgram::BuildShadersFromFiles(const char* filenameBasePath, const char* vertexShaderFilename, const char* fragmentShaderFilename, const char* geometryShaderFilename, const char* tessellationControlShaderFilename, const char* tessellationEvaluationShaderFilename) {
...
int PipelineProgram::BuildShadersFromStrings(const char* vertexShaderCode, const char* fragmentShaderCode, const char* geometryShaderCode, const char* tessellationControlShaderCode, const char* tessellationEvaluationShaderCode) {
...
int PipelineProgram::PreLink() { return 0; }
void PipelineProgram::Bind() { glUseProgram(programHandle); }
